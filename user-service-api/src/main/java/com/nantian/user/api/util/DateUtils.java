...
public class DateUtils {
    ...
    public static final String TIME6 = "HHmmss";
    public static final String DATEHOURNUMBERFORMAT = "yyyyMMddHH";
    public static final String DATE_FORMAT_HOUR = "H";
    public static final String TIME9 = "HHmmssSSS";

    public static final DateTimeFormatter DATE_FORMAT_8 = DateTimeFormatter.ofPattern(DATE8);
    public static final DateTimeFormatter DATE_FORMAT_14 = DateTimeFormatter.ofPattern(DateUtils.DATEFORMATLONG14);
    public static final DateTimeFormatter DATE_FORMAT_19 = DateTimeFormatter.ofPattern(DateUtils.DATEFORMATLONG19);
    ...
    public static Date string2Date(String strDate){
        SimpleDateFormat sdf = new SimpleDateFormat(DATEFORMATLONG19);
    ...
    public static String getCurrentYearMonthDate() {
        return getCurrentFormatDate(DATE_MONTH);
    }
    ...
    public static String getCurrentFormatDateLong15() {
        return getCurrentFormatDate("yyyyMMddHHmmssSSS");
    }
    public static String getCurrentFormatDateLong16() {
    ...
    public static Date getString2LongDate1(String str) {
        return getString2Date("yyyyMMddHHmmss", str);
    }
    ...
    public static String getCurrentLastMonth() {
        SimpleDateFormat format = new SimpleDateFormat(DATE_MONTH);
        Calendar cal = Calendar.getInstance();
        cal.add(2, -1);
     ...
     * @param endDate
     * @return
     * @Description 计算两个日期的年份
     */
    public static int yearDateDiff(String startDate, String endDate) {
        Calendar calBengin = Calendar.getInstance();
        Calendar calEnd = Calendar.getInstance();
        calBengin.setTime(stringTodate(startDate, "yyyy-MM-dd"));
        calEnd.setTime(stringTodate(endDate, "yyyy-MM-dd"));
        return calEnd.get(Calendar.YEAR) - calBengin.get(Calendar.YEAR);
    }
    ...
    public static String getTime9NumberString9(Date date) {
        return getDate2String("HHmmssSSS", date);
    }
